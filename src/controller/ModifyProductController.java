...
/**
 * The ModifyProductController class controls the ModifyProductScreen.fxml.
 */
public class ModifyProductController implements Initializable {

    Product product = new Product(1000, null, 0, 0, 0, 0);
    // ObservableList<Part> tempAssociatedParts = MenuController.getModifyProduct().getAllAssociatedParts(); //original
    ...
    void onActionAddAssociatedPart(ActionEvent event) {
        // ObservableList<Part> tempAssociatedParts = MenuController.getModifyProduct().getAllAssociatedParts();
        setTempAssociatedParts();
    ...
    /**
     * The onActionSave method allows a user to modify an existing product and returns to the MenuScreen.
    ...
    void onActionSave(ActionEvent event) throws IOException {
        ...
        try {
            ...
            if(valueError.length() > 0) {
                ...
                alert.setHeaderText("Invalid input. Product not modified. See value error(s) below.");
                ...
                Inventory.updateProduct(MenuController.getModifyProductIndex(), product);
    ...
    /**
     * The SendProduct method is utilized by the MenuController to populate the selected data into the ModifyProductScreen.
     * @param product the product to modify
     */
    public void SendProduct(Product product) {
        productIdInput.setText(String.valueOf(product.getId()));
        productNameInput.setText(String.valueOf(product.getName()));
        productInventoryInput.setText(String.valueOf(product.getStock()));
        productPriceInput.setText(String.valueOf(product.getPrice()));
        productMaxInput.setText(String.valueOf(product.getMax()));
        productMinInput.setText(String.valueOf(product.getMin()));
    ...
    /**
     * The setTempAssociatedParts method sets a temporary list into the associatedParts table that will not save if cancelled.
     */
    public void setTempAssociatedParts() {
        associatedPartTable.setItems(tempAssociatedParts);
    }
}
